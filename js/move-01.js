...
function moveMessage(moveId, targetLeft, targetTop, interval) {
    ...
    if(movingTop == targetTop && movingLeft == targetLeft) return true;
    ...
    var repeat = "moveMessage('" + moveId + "'," + targetLeft + ", " + targetTop + ", " + interval + ")";
